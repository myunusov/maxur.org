 ...
 */
public class YamlNavigationBehavior extends BaseResourcesBehavior implements StyleBehavior {
    ...
    public void renderHead(Component component, IHeaderResponse response) {
        ...
        response.render(CssHeaderItem.forReference(
                new CssResourceReference(this.getClass(), "/navigation/hlist.css")
        ));
        response.render(CssHeaderItem.forReference(
                new CssResourceReference(this.getClass(), "/navigation/vlist.css")
        ));
    }
