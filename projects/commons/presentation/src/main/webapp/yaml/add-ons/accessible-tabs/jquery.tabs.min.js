...
(function($) {
    var debugMode = true;
    $.fn.extend({getUniqueId:function(p, q, r) {
        if (r === undefined) {
            r = ""
        } else {
            r = "-" + r
        ...
        return this.each(function(t) {
            ...
            $(el).find(o.options.tabhead).each(function(i) {
                ...
                var tabId = o.getUniqueId("accessibletabscontent", t, i);
                var navItemId = o.getUniqueId("accessibletabsnavigation", t, i);
                ids.push(tabId);
                ...
                $(this).attr({id:tabId,"class":o.options.tabheadClass,tabindex:"-1"});
                tabCount++
            });
